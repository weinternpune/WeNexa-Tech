    ...
    >
      ...
      >
        ...
        >
          ...
          {/* GLOW */}
          <div className="absolute top-[-30px] right-[-30px] w-[120px] h-[120px] bg-green-400/10 blur-[70px]" />
      ...
      >
        ...
        {/* GLOW */}
        <div className="absolute inset-0 rounded-full bg-green-400/10 blur-xl" />
