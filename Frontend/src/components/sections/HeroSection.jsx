    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full">
            ...
            >
              ...
              <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:gap-3">
                ...
                <a
                  ...
                  className="group relative overflow-hidden w-full sm:w-auto py-2.5 sm:py-3 px-4 rounded-2xl border border-white/10 bg-white/[0.03] flex items-center justify-center gap-2 text-white font-medium text-sm backdrop-blur-xl transition-all duration-300 active:scale-95 touch-manipulation hover:-translate-y-[2px] hover:border-[#00C97B]/20"
                >
        ...
        <div className="relative z-20 w-full bg-[#07111F] border-t border-white/[0.08] shadow-[0_-4px_24px_rgba(0,0,0,0.4)]">
          ...
          <div className="sm:hidden px-3 py-2 space-y-1.5 w-full mx-auto">
            <div className="grid grid-cols-3 gap-1.5">
              {features.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="relative flex flex-col items-center justify-center gap-1 py-2 px-1 rounded-xl bg-white/[0.03] border border-white/[0.07] overflow-hidden"
                  >
                    ...
                    <div className="text-center leading-none">
                      ...
                      <div className="text-white/45 text-[8px] mt-0.5">
                        {item.subtitle}
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-4 gap-1.5">
              {stats.map((item, index) => (
                <div
                  key={index}
                  className="relative flex flex-col items-center justify-center gap-0.5 py-2 rounded-xl bg-white/[0.03] border border-white/[0.07] overflow-hidden"
                >
                  <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#00C97B]/60 to-transparent" />

                  <h3 className="text-white text-[13px] font-black leading-none tracking-tight">
                    {item.value}
                  </h3>

                  <p className="text-white/50 text-[7px] font-medium text-center px-1 leading-tight">
                    {item.label}
                  </p>
                  ...
                  {item.stars && (
                    <div className="flex gap-px mt-0.5">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <span
                          key={i}
                          className="text-[#FFC83D] text-[6px]"
                        >
                          ★
                        </span>
                      ))}
          ...
          <div className="hidden sm:block lg:hidden px-5 py-3 space-y-2 max-w-7xl mx-auto w-full">
            <div className="grid grid-cols-5 gap-2">
              {features.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="relative flex flex-col items-center justify-center gap-1.5 py-3 rounded-2xl bg-white/[0.03] border border-white/[0.07] overflow-hidden"
                  >
                    <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#00C97B]/60 to-transparent" />
            ...
            <div className="grid grid-cols-4 gap-2">
              {stats.map((item, index) => (
                <div
                  key={index}
                  className="relative flex flex-col items-center justify-center gap-1 py-3 rounded-2xl bg-white/[0.03] border border-white/[0.07] overflow-hidden"
                >
                  <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#00C97B]/60 to-transparent" />

                  <h3 className="text-white text-[22px] font-black leading-none tracking-tight">
                    {item.value}
                  </h3>
          ...
          {/* DESKTOP */}
          <div className="hidden lg:grid grid-cols-9 gap-2 px-6 xl:px-10 py-3 max-w-7xl mx-auto w-full">
            {features.map((item, index) => {
              const Icon = item.icon;
              ...
              return (
                <div
                  key={index}
                  className="relative flex flex-col items-center justify-center gap-1 py-3 rounded-xl bg-white/[0.03] border border-white/[0.07] overflow-hidden group hover:border-[#00C97B]/25 hover:bg-[#00C97B]/[0.04] transition-all duration-300"
                >
                  ...
                  <div className="text-center leading-none px-1">
                    <div className="text-white text-[10px] xl:text-[11px] font-bold">
                      {item.title}
                    </div>

                    <div className="text-white/45 text-[9px] xl:text-[10px] mt-0.5">
                      {item.subtitle}
                    </div>
                  </div>
                </div>
            ...
            {stats.map((item, index) => (
              <div
                key={index}
                className="relative flex flex-col items-center justify-center gap-1 py-3 rounded-xl bg-white/[0.03] border border-white/[0.07] overflow-hidden"
              >
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#00C97B]/50 to-transparent" />

                <h3 className="text-white text-[20px] xl:text-[22px] font-black leading-none tracking-tight">
                  {item.value}
                </h3>

                <p className="text-white/60 text-[10px] xl:text-[11px] font-medium text-center px-1">
                  {item.label}
                </p>
