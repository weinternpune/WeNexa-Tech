          ...
          <div className="flex items-center justify-center">
            ...
            <div className="flex items-stretch shrink-0">
              {stats.map((item, index) => (
                <div
                  key={index}
                  className="relative px-2 xl:px-5 flex flex-col items-center justify-center text-center border-l border-white/[0.08] first:border-l-0"
                >
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[60px] h-[1px] bg-[#00C97B]/30" />

                  <h3 className="text-white text-[17px] xl:text-[22px] leading-none font-black tracking-[-0.03em]">
                    {item.value}
                  </h3>

                  <p className="mt-1 text-[10px] xl:text-[12px] font-medium text-white/60 whitespace-nowrap">
                    {item.label}
                  </p>
                  ...
                  {item.stars && (
                    <div className="flex items-center gap-0.5 xl:gap-1 mt-1">
                      {Array.from({ length: 5 }).map((_, i) => (
                        <span
                          key={i}
                          className="text-[#FFC83D] text-[9px] xl:text-[10px]"
                        >
                          ★
                        </span>
                      ))}
