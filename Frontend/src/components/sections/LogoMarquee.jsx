...
export default function LogoMarquee() {
  ...
  return (
    <section className="relative py-20 overflow-hidden bg-white border-y border-[#e7eaee]">
      {/* Background */}
      ...
      {/* Fade Edges */}
      <div className="absolute left-0 top-0 bottom-0 w-32 z-20 bg-gradient-to-r from-white via-white/90 to-transparent pointer-events-none" />

      <div className="absolute right-0 top-0 bottom-0 w-32 z-20 bg-gradient-to-l from-white via-white/90 to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="max-w-2xl mx-auto text-[#0f172a]/60 text-base leading-relaxed">
